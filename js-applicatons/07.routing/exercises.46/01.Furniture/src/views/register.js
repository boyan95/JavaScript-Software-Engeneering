    ...
    <div class="row space-top">
      <div class="col-md-4">
        ...
        <div class="form-group">
          ...
          <input
            class=${"form-control" + (errors.email ? " is-invalid" : " is-valid")}
            id="email"
            type="text"
            name="email"
          />
        ...
        <div class="form-group">
          ...
          <input
            class=${"form-control" + (errors.password ? " is-invalid" : " is-valid")}
            id="password"
            type="password"
            name="password"
          />
        ...
        <div class="form-group">
          ...
          <input
            class=${"form-control" + (errors.rePass ? " is-invalid" : " is-valid")}
            id="rePass"
            type="password"
            name="rePass"
          />
...
export function registerPage(ctx) {
  ...
  async function onsubmit(event) {
    ...
    try {
      if (email == "" || password == "") {
        throw {
          error: new Error("All fields are require!"),
          errors: {
            email: email == "",
            password: password == "",
            rePass: rePass == "",
